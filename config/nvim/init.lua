...
require('lazy').setup({
  ...
  { -- Main LSP Configuration
    ...
    config = function()
      -- Native configuration defaults using Neovim 0.11+ mechanisms
      -- We define our servers and pass them straight to vim.lsp.enable

      -- 1. GDScript
      vim.lsp.enable('gdscript', {
        cmd = { 'nc', '127.0.0.1', '6005' },
        filetypes = { 'gd', 'gdscript' },
        root_dir = vim.fs.root(0, 'project.godot'), -- Modern replacement for lspconfig.util.root_pattern
      })
      ...
      -- Global LSP Attach Handler for Mappings/Autocmds
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Keymaps adjusted to core API or telescope hooks
          ...
          -- Clean structural capability check for document highlights using native methods
